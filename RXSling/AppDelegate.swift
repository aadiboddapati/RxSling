...
//Users
//manish.r@rxprism.com
//12345678
//
//sunilkumar.gc@rxprism.com
//12345678
...
//        SideMenuManager.default.addScreenEdgePanGesturesToPresent(toView: self.navigationController!.view)
        CNContactStore().requestAccess(for: .contacts, completionHandler: {(access, error) in print("Access: \(access)")
    ...
    func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) {
      print("APNs token retrieved in Data: \(deviceToken)")
        let deviceTokenString = deviceToken.hexString
        print("APNs token retrieved in String: \(deviceTokenString)")
    ...
    func messaging(_ messaging: Messaging, didReceiveRegistrationToken fcmToken: String) {
      ...
      UserDefaults.standard.set(fcmToken, forKey: "PUSH_ID")
